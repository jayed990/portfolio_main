...
<html lang="en">
  <head>
    ...
    <title>Jayed Bin Jahangir</title>
    ...
    <div id="page-wraper">
      ...
      <div class="responsive-nav">
        ...
        <div id="menu" class="menu">
          ...
          <div class="container">
            <div class="image">
              <a href="#"><img src="assets/images/author.png" alt="" /></a>
            </div>
            <div class="author-content">
              <h4>Jayed Bin Jahangir</h4>
              <span>Researcher - Software Developer</span>
            </div>
            <nav class="main-nav" role="navigation">
              <ul class="main-menu">
                <li><a href="#section1">About Me</a></li>
                <li><a href="#section2">Skills & Experiences</a></li>
            ...
            <div class="social-network">
              <ul class="soial-icons">
                <li>
                  <a href="https://fb.com/jayed.shibli"
                    ><i class="fa fa-facebook"></i
                  ></a>
                </li>
                <li>
                  <a href="https://twitter.com/JShibli"><i class="fa fa-twitter"></i></a>
                </li>
                <li>
                  <a href="https://www.linkedin.com/in/jayed-shibli-9a0a461ba"><i class="fa fa-linkedin"></i></a>
                </li>
                <li>
                  <a href="https://dribbble.com/jayed990"><i class="fa fa-dribbble"></i></a>
                </li>
              </ul>
            </div>
      ...
      <section class="section about-me" data-section="section1">
        <div class="container">
          <div class="section-heading">
            ...
            <span
            >Hi there this is Jayed, student of Computer Science & Engineering.</br>
              Myself a Researcher and ML | AI enthusiast.</span
            >
          </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="left-image">
                  <img src="assets/images/cv_img.png" alt="" />
                </div>
              </div>
              <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="service-item">
                ...
                <h4>JAVA A+pplication</h4>
                <p>
                  Desktop application using JAVA with user-friendly GUI. 
                </p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="service-item">
                ...
                <p>
                  Train / Test various kinds of DATA and generate optimal output for your Business / Projects.
                </p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="service-item">
                ...
                <h4>SQL Databases</h4>
                <p>
                  Create and Manage Online / Offline database using MySQL / PostgreSQL.
                </p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="service-item">
                ...
                <p>
                  Create ML models which will do critical & time comsuming task within moments.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="right-content">
              <div class="container">
                <form id="contact" action="https://formsubmit.co/jayed990@gmail.com" method="post">
                  <div class="row">
                    <div class="col-md-6">
                      <fieldset>
                        <input
